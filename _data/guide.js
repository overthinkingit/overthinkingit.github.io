module.exports = {
  ...
  stages: [
    ...
    },
    {
      ...
      name: "Foundations",
      intro:
        "The frame everything else assumes — the diagnosis, the path, and the analysis of experience.",
      items: [
        {
    ...
    },
    {
      ...
      name: "Deepening",
      intro:
        "Once you are sitting regularly — the practices and obstacles that shape day-to-day training.",
      items: [
        {
    ...
    },
    {
      ...
      items: [
        ...
        },
        {
          ...
          annotation:
            "The four absorptions, their factors, and their relationship to insight.",
        },
        {
